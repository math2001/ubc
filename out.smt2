...
(assert (= node_guard_n36_ok (and (=> (and (and (and PMS@assigned~2 Mem@assigned~2) GhostAssertions@assigned~2) HTD@assigned~2) node_prove_guard_n36_36_ok) (=> (not (and (and (and PMS@assigned~2 Mem@assigned~2) GhostAssertions@assigned~2) HTD@assigned~2)) node_Err_ok))))
