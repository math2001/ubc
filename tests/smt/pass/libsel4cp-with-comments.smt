(
  ...
  (forall ((x PMS)) (or (= x PMS!val!1) (= x PMS!val!2) (= x PMS!val!0)))
  ;; -----------
  ;; universe for HTD:
  ...
  (define-fun GhostAssertions/call-arg~7 () (Array (_ BitVec 50) (_ BitVec 64))
    ((as const (Array (_ BitVec 50) (_ BitVec 64))) #xffefeffdbfff7f5d))
  ...
  (define-fun GhostAssertions~3 () (Array (_ BitVec 50) (_ BitVec 64))
    ((as const (Array (_ BitVec 50) (_ BitVec 64))) #xf48b029830cf2063))
  ...
  (define-fun GhostAssertions/call-arg~3 () (Array (_ BitVec 50) (_ BitVec 64))
    ((as const (Array (_ BitVec 50) (_ BitVec 64))) #x03648c42cd204e18))
