...
(define-fun node_Err_ok_0 () Bool true)
(define-fun node_Err_ok_1 () Bool true)
(define-fun node_Err_ok_2 () Bool true)
(define-fun node_Err_ok_3 () Bool true)
(define-fun node_Err_ok_4 () Bool true)
(define-fun node_Err_ok_5 () Bool true)
(define-fun node_Err_ok_6 () Bool true)
(define-fun node_Err_ok_7 () Bool true)
(define-fun node_Err_ok_8 () Bool true)
(define-fun node_Err_ok_9 () Bool true)
(define-fun node_Err_ok_10 () Bool true)
(define-fun node_Err_ok_11 () Bool true)
(define-fun node_Err_ok_12 () Bool true)
(define-fun node_Err_ok_13 () Bool true)
(define-fun node_Err_ok_14 () Bool true)
(define-fun node_Err_ok_15 () Bool true)
(define-fun node_Err_ok_16 () Bool true)
(define-fun node_Err_ok_17 () Bool true)
(define-fun node_Err_ok_18 () Bool true)
(define-fun node_Err_ok_19 () Bool true)
(define-fun node_Err_ok_20 () Bool true)
(define-fun node_Err_ok_21 () Bool true)
(define-fun node_Err_ok_22 () Bool true)
(define-fun node_Err_ok_23 () Bool true)
(define-fun node_Err_ok_24 () Bool true)
(define-fun node_Err_ok_25 () Bool true)
(define-fun node_Err_ok_26 () Bool true)
(define-fun node_Err_ok_27 () Bool true)
(define-fun node_Err_ok_28 () Bool true)
(define-fun node_Err_ok_29 () Bool true)
(define-fun node_Err_ok_30 () Bool true)
(define-fun node_Err_ok_31 () Bool true)
(define-fun node_Err_ok_32 () Bool true)
...
(assert (= node_upd_n49_ok (=> (= Mem@assigned~1 true) (=> (= HTD@assigned~1 true) (=> (= PMS@assigned~1 true) (=> (= GhostAssertions@assigned~1 true) (=> (= rv@space@ret__struct_seL4_MessageInfo_C@v.words_C.0@assigned~1 false) (=> (= badge___unsigned_longlong@v@assigned~1 false) (=> (= loop@2@count@assigned~1 false) (=> (= idx___unsigned@v@assigned~1 false) (=> (= have_reply___char@v@assigned~1 false) (=> (= loop@9@count@assigned~1 false) (=> (= reply_tag___struct_seL4_MessageInfo_C@v.words_C.0@assigned~1 false) (=> (= is_endpoint___unsigned_longlong@v@assigned~1 false) (=> (= tag___struct_seL4_MessageInfo_C@v.words_C.0@assigned~1 false) node_39_ok)))))))))))))))
...
(assert (= node_loop_3_latch_1_ok (and (=> (and (and (and (and (and (and (and (= (not (= have_reply___char@v~1 (_ bv0 8))) (not (= reply_tag___struct_seL4_MessageInfo_C@v.words_C.0@assigned~1 false))) (=> (= is_endpoint___unsigned_longlong@v@assigned~1 true) (= (not (= is_endpoint___unsigned_longlong@v~1 (_ bv0 64))) (not (= have_reply___char@v~1 (_ bv0 8)))))) (=> (= is_endpoint___unsigned_longlong@v@assigned~1 true) (= is_endpoint___unsigned_longlong@v@assigned~1 reply_tag___struct_seL4_MessageInfo_C@v.words_C.0@assigned~1))) (= HTD@assigned~1 true)) (= Mem@assigned~1 true)) (= PMS@assigned~1 true)) (= GhostAssertions@assigned~1 true)) (= have_reply___char@v@assigned~2 true)) node_3_ok) (=> (not (and (and (and (and (and (and (and (= (not (= have_reply___char@v~1 (_ bv0 8))) (not (= reply_tag___struct_seL4_MessageInfo_C@v.words_C.0@assigned~1 false))) (=> (= is_endpoint___unsigned_longlong@v@assigned~1 true) (= (not (= is_endpoint___unsigned_longlong@v~1 (_ bv0 64))) (not (= have_reply___char@v~1 (_ bv0 8)))))) (=> (= is_endpoint___unsigned_longlong@v@assigned~1 true) (= is_endpoint___unsigned_longlong@v@assigned~1 reply_tag___struct_seL4_MessageInfo_C@v.words_C.0@assigned~1))) (= HTD@assigned~1 true)) (= Mem@assigned~1 true)) (= PMS@assigned~1 true)) (= GhostAssertions@assigned~1 true)) (= have_reply___char@v@assigned~2 true))) node_Err_ok_0))))
(assert (= node_3_ok (and (=> true node_loop_3_inv_asm_1_ok) (=> false node_loop_3_inv_asm_2_ok))))
(assert (= node_loop_3_inv_asm_2_ok (=> (and (and (and (and (and (and (and (= (not (= have_reply___char@v~2 (_ bv0 8))) (not (= reply_tag___struct_seL4_MessageInfo_C@v.words_C.0@assigned~2 false))) (=> (= is_endpoint___unsigned_longlong@v@assigned~2 true) (= (not (= is_endpoint___unsigned_longlong@v~1 (_ bv0 64))) (not (= have_reply___char@v~2 (_ bv0 8)))))) (=> (= is_endpoint___unsigned_longlong@v@assigned~2 true) (= is_endpoint___unsigned_longlong@v@assigned~2 reply_tag___struct_seL4_MessageInfo_C@v.words_C.0@assigned~2))) (= HTD@assigned~2 true)) (= Mem@assigned~2 true)) (= PMS@assigned~2 true)) (= GhostAssertions@assigned~2 true)) (= have_reply___char@v@assigned~3 true)) node_Err_ok_1)))
(assert (= node_loop_3_inv_asm_1_ok (=> (and (and (and (and (and (and (and (= (not (= have_reply___char@v~2 (_ bv0 8))) (not (= reply_tag___struct_seL4_MessageInfo_C@v.words_C.0@assigned~2 false))) (=> (= is_endpoint___unsigned_longlong@v@assigned~2 true) (= (not (= is_endpoint___unsigned_longlong@v~1 (_ bv0 64))) (not (= have_reply___char@v~2 (_ bv0 8)))))) (=> (= is_endpoint___unsigned_longlong@v@assigned~2 true) (= is_endpoint___unsigned_longlong@v@assigned~2 reply_tag___struct_seL4_MessageInfo_C@v.words_C.0@assigned~2))) (= HTD@assigned~2 true)) (= Mem@assigned~2 true)) (= PMS@assigned~2 true)) (= GhostAssertions@assigned~2 true)) (= have_reply___char@v@assigned~3 true)) node_4_ok)))
...
(assert (= node_post_condition_ok (and (=> true node_Ret_ok) (=> false node_Err_ok_2))))
(assert (= node_guard_n38_ok (and (=> have_reply___char@v@assigned~3 node_38_ok) (=> (not have_reply___char@v@assigned~3) node_Err_ok_3))))
(assert (= node_38_ok (and (=> (not (= have_reply___char@v~2 (_ bv0 8))) node_32_ok) (=> (= have_reply___char@v~2 (_ bv0 8)) node_37_ok))))
(assert (= node_37_ok (and (=> true node_guard_n36_ok) (=> (not true) node_Err_ok_4))))
(assert (= node_guard_n36_ok (and (=> (and (and (and PMS@assigned~2 Mem@assigned~2) GhostAssertions@assigned~2) HTD@assigned~2) node_prove_guard_n36_36_ok) (=> (not (and (and (and PMS@assigned~2 Mem@assigned~2) GhostAssertions@assigned~2) HTD@assigned~2)) node_Err_ok_5))))
...
(assert (= node_guard_n35_ok (and (=> rv@space@ret__struct_seL4_MessageInfo_C@v.words_C.0@assigned~3 node_35_ok) (=> (not rv@space@ret__struct_seL4_MessageInfo_C@v.words_C.0@assigned~3) node_Err_ok_6))))
...
(assert (= node_34_ok (and (=> true node_guard_n33_ok) (=> (not true) node_Err_ok_7))))
(assert (= node_guard_n33_ok (and (=> Mem@assigned~3 node_33_ok) (=> (not Mem@assigned~3) node_Err_ok_8))))
...
(assert (= node_32_ok (and (=> true node_guard_n31_ok) (=> (not true) node_Err_ok_9))))
(assert (= node_guard_n31_ok (and (=> (and (and (and (and Mem@assigned~2 reply_tag___struct_seL4_MessageInfo_C@v.words_C.0@assigned~2) GhostAssertions@assigned~2) PMS@assigned~2) HTD@assigned~2) node_prove_guard_n31_31_ok) (=> (not (and (and (and (and Mem@assigned~2 reply_tag___struct_seL4_MessageInfo_C@v.words_C.0@assigned~2) GhostAssertions@assigned~2) PMS@assigned~2) HTD@assigned~2)) node_Err_ok_10))))
...
(assert (= node_guard_n30_ok (and (=> rv@space@ret__struct_seL4_MessageInfo_C@v.words_C.0@assigned~3 node_30_ok) (=> (not rv@space@ret__struct_seL4_MessageInfo_C@v.words_C.0@assigned~3) node_Err_ok_11))))
...
(assert (= node_29_ok (and (=> true node_guard_n28_ok) (=> (not true) node_Err_ok_12))))
(assert (= node_guard_n28_ok (and (=> Mem@assigned~3 node_28_ok) (=> (not Mem@assigned~3) node_Err_ok_13))))
...
(assert (= node_27_ok (and (=> (and (bvsle (_ bv0 64) (_ bv63 64)) (bvslt (_ bv63 64) (_ bv64 64))) node_guard_n26_ok) (=> (not (and (bvsle (_ bv0 64) (_ bv63 64)) (bvslt (_ bv63 64) (_ bv64 64)))) node_Err_ok_14))))
(assert (= node_guard_n26_ok (and (=> badge___unsigned_longlong@v@assigned~3 node_26_ok) (=> (not badge___unsigned_longlong@v@assigned~3) node_Err_ok_15))))
...
(assert (= node_guard_n25_ok (and (=> is_endpoint___unsigned_longlong@v@assigned~3 node_25_ok) (=> (not is_endpoint___unsigned_longlong@v@assigned~3) node_Err_ok_16))))
...
(assert (= node_guard_n22_ok (and (=> badge___unsigned_longlong@v@assigned~3 node_22_ok) (=> (not badge___unsigned_longlong@v@assigned~3) node_Err_ok_17))))
...
(assert (= node_j1_ok (=> (= PMS~5 PMS~3) (=> (= Mem~5 Mem~3) (=> (= HTD@assigned~5 HTD@assigned~3) (=> (= GhostAssertions~5 GhostAssertions~3) (=> (= PMS@assigned~5 PMS@assigned~3) (=> (= GhostAssertions@assigned~5 GhostAssertions@assigned~3) (=> (= HTD~5 HTD~3) (=> (= Mem@assigned~5 Mem@assigned~3) node_20_ok))))))))))
(assert (= node_guard_n21_ok (and (=> (and (and (and (and Mem@assigned~3 idx___unsigned@v@assigned~3) GhostAssertions@assigned~3) PMS@assigned~3) HTD@assigned~3) node_prove_guard_n21_21_ok) (=> (not (and (and (and (and Mem@assigned~3 idx___unsigned@v@assigned~3) GhostAssertions@assigned~3) PMS@assigned~3) HTD@assigned~3)) node_Err_ok_18))))
...
(assert (= node_j2_ok (=> (= PMS~5 PMS~4) (=> (= Mem~5 Mem~4) (=> (= HTD@assigned~5 HTD@assigned~4) (=> (= GhostAssertions~5 GhostAssertions~4) (=> (= PMS@assigned~5 PMS@assigned~4) (=> (= GhostAssertions@assigned~5 GhostAssertions@assigned~4) (=> (= HTD~5 HTD~4) (=> (= Mem@assigned~5 Mem@assigned~4) node_20_ok))))))))))
(assert (= node_20_ok (and (=> (and (bvsle (_ bv0 64) (_ bv1 64)) (bvslt (_ bv1 64) (_ bv64 64))) node_guard_n19_ok) (=> (not (and (bvsle (_ bv0 64) (_ bv1 64)) (bvslt (_ bv1 64) (_ bv64 64)))) node_Err_ok_19))))
(assert (= node_guard_n19_ok (and (=> badge___unsigned_longlong@v@assigned~3 node_19_ok) (=> (not badge___unsigned_longlong@v@assigned~3) node_Err_ok_20))))
...
(assert (= node_guard_n18_ok (and (=> idx___unsigned@v@assigned~3 node_18_ok) (=> (not idx___unsigned@v@assigned~3) node_Err_ok_21))))
...
(assert (= node_guard_n11_ok (and (=> badge___unsigned_longlong@v@assigned~5 node_11_ok) (=> (not badge___unsigned_longlong@v@assigned~5) node_Err_ok_24))))
...
(assert (= node_j5_ok (=> (= loop@9@count~4 loop@9@count~3) (=> (= reply_tag___struct_seL4_MessageInfo_C@v.words_C.0~3 reply_tag___struct_seL4_MessageInfo_C@v.words_C.0~1) (=> (= PMS~7 PMS~6) (=> (= Mem~7 Mem~6) (=> (= rv@space@ret__struct_seL4_MessageInfo_C@v.words_C.0~4 rv@space@ret__struct_seL4_MessageInfo_C@v.words_C.0~2) (=> (= badge___unsigned_longlong@v~5 badge___unsigned_longlong@v~4) (=> (= HTD@assigned~7 HTD@assigned~6) (=> (= rv@space@ret__struct_seL4_MessageInfo_C@v.words_C.0@assigned~5 rv@space@ret__struct_seL4_MessageInfo_C@v.words_C.0@assigned~3) (=> (= GhostAssertions~7 GhostAssertions~6) (=> (= PMS@assigned~7 PMS@assigned~6) (=> (= badge___unsigned_longlong@v@assigned~6 badge___unsigned_longlong@v@assigned~5) (=> (= GhostAssertions@assigned~7 GhostAssertions@assigned~6) (=> (= HTD~7 HTD~6) (=> (= idx___unsigned@v@assigned~6 idx___unsigned@v@assigned~5) (=> (= idx___unsigned@v~5 idx___unsigned@v~4) (=> (= reply_tag___struct_seL4_MessageInfo_C@v.words_C.0@assigned~4 reply_tag___struct_seL4_MessageInfo_C@v.words_C.0@assigned~2) (=> (= Mem@assigned~7 Mem@assigned~6) node_2_ok)))))))))))))))))))
(assert (= node_guard_n17_ok (and (=> badge___unsigned_longlong@v@assigned~5 node_17_ok) (=> (not badge___unsigned_longlong@v@assigned~5) node_Err_ok_25))))
...
(assert (= node_j3_ok (=> (= PMS~8 PMS~6) (=> (= Mem~8 Mem~6) (=> (= HTD@assigned~8 HTD@assigned~6) (=> (= GhostAssertions~8 GhostAssertions~6) (=> (= PMS@assigned~8 PMS@assigned~6) (=> (= GhostAssertions@assigned~8 GhostAssertions@assigned~6) (=> (= HTD~8 HTD~6) (=> (= Mem@assigned~8 Mem@assigned~6) node_15_ok))))))))))
(assert (= node_guard_n16_ok (and (=> (and (and (and (and Mem@assigned~6 idx___unsigned@v@assigned~5) GhostAssertions@assigned~6) PMS@assigned~6) HTD@assigned~6) node_prove_guard_n16_16_ok) (=> (not (and (and (and (and Mem@assigned~6 idx___unsigned@v@assigned~5) GhostAssertions@assigned~6) PMS@assigned~6) HTD@assigned~6)) node_Err_ok_26))))
...
(assert (= node_j4_ok (=> (= PMS~8 PMS~7) (=> (= Mem~8 Mem~7) (=> (= HTD@assigned~8 HTD@assigned~7) (=> (= GhostAssertions~8 GhostAssertions~7) (=> (= PMS@assigned~8 PMS@assigned~7) (=> (= GhostAssertions@assigned~8 GhostAssertions@assigned~7) (=> (= HTD~8 HTD~7) (=> (= Mem@assigned~8 Mem@assigned~7) node_15_ok))))))))))
(assert (= node_15_ok (and (=> (and (bvsle (_ bv0 64) (_ bv1 64)) (bvslt (_ bv1 64) (_ bv64 64))) node_guard_n14_ok) (=> (not (and (bvsle (_ bv0 64) (_ bv1 64)) (bvslt (_ bv1 64) (_ bv64 64)))) node_Err_ok_27))))
(assert (= node_guard_n14_ok (and (=> badge___unsigned_longlong@v@assigned~5 node_14_ok) (=> (not badge___unsigned_longlong@v@assigned~5) node_Err_ok_28))))
...
(assert (= node_guard_n13_ok (and (=> idx___unsigned@v@assigned~5 node_13_ok) (=> (not idx___unsigned@v@assigned~5) node_Err_ok_29))))
...
(assert (= node_loop_10_latch_2_ok (=> (not (and (and (and (and (and (and (= is_endpoint___unsigned_longlong@v~2 (_ bv0 64)) (= badge___unsigned_longlong@v@assigned~6 true)) (= idx___unsigned@v@assigned~6 true)) (= HTD@assigned~8 true)) (= Mem@assigned~8 true)) (= PMS@assigned~8 true)) (= GhostAssertions@assigned~8 true))) node_Err_ok_30)))
...
(assert (= node_guard_n7_ok (and (=> (and (and (and (and (and Mem@assigned~3 badge___unsigned_longlong@v@assigned~3) GhostAssertions@assigned~3) PMS@assigned~3) tag___struct_seL4_MessageInfo_C@v.words_C.0@assigned~3) HTD@assigned~3) node_prove_guard_n7_7_ok) (=> (not (and (and (and (and (and Mem@assigned~3 badge___unsigned_longlong@v@assigned~3) GhostAssertions@assigned~3) PMS@assigned~3) tag___struct_seL4_MessageInfo_C@v.words_C.0@assigned~3) HTD@assigned~3)) node_Err_ok_31))))
...
(assert (= node_guard_n6_ok (and (=> rv@space@ret__struct_seL4_MessageInfo_C@v.words_C.0@assigned~4 node_6_ok) (=> (not rv@space@ret__struct_seL4_MessageInfo_C@v.words_C.0@assigned~4) node_Err_ok_32))))
...
(assert (= node_j6_ok (=> (= loop@9@count~4 loop@9@count~1) (=> (= reply_tag___struct_seL4_MessageInfo_C@v.words_C.0~3 reply_tag___struct_seL4_MessageInfo_C@v.words_C.0~2) (=> (= PMS~7 PMS~4) (=> (= Mem~7 Mem~4) (=> (= rv@space@ret__struct_seL4_MessageInfo_C@v.words_C.0~4 rv@space@ret__struct_seL4_MessageInfo_C@v.words_C.0~3) (=> (= badge___unsigned_longlong@v~5 badge___unsigned_longlong@v~2) (=> (= HTD@assigned~7 HTD@assigned~4) (=> (= rv@space@ret__struct_seL4_MessageInfo_C@v.words_C.0@assigned~5 rv@space@ret__struct_seL4_MessageInfo_C@v.words_C.0@assigned~4) (=> (= GhostAssertions~7 GhostAssertions~4) (=> (= PMS@assigned~7 PMS@assigned~4) (=> (= badge___unsigned_longlong@v@assigned~6 badge___unsigned_longlong@v@assigned~3) (=> (= GhostAssertions@assigned~7 GhostAssertions@assigned~4) (=> (= HTD~7 HTD~4) (=> (= idx___unsigned@v@assigned~6 idx___unsigned@v@assigned~2) (=> (= idx___unsigned@v~5 idx___unsigned@v~1) (=> (= reply_tag___struct_seL4_MessageInfo_C@v.words_C.0@assigned~4 reply_tag___struct_seL4_MessageInfo_C@v.words_C.0@assigned~3) (=> (= Mem@assigned~7 Mem@assigned~4) node_2_ok)))))))))))))))))))
(assert (= node_2_ok (=> (= loop@2@count~3 (bvadd loop@2@count~2 (_ bv1 64))) node_loop_3_latch_2_ok)))
(assert (= node_loop_3_latch_2_ok (=> (not (and (and (and (and (and (and (and (= (not (= have_reply___char@v~3 (_ bv0 8))) (not (= reply_tag___struct_seL4_MessageInfo_C@v.words_C.0@assigned~4 false))) (=> (= is_endpoint___unsigned_longlong@v@assigned~3 true) (= (not (= is_endpoint___unsigned_longlong@v~2 (_ bv0 64))) (not (= have_reply___char@v~3 (_ bv0 8)))))) (=> (= is_endpoint___unsigned_longlong@v@assigned~3 true) (= is_endpoint___unsigned_longlong@v@assigned~3 reply_tag___struct_seL4_MessageInfo_C@v.words_C.0@assigned~4))) (= HTD@assigned~7 true)) (= Mem@assigned~7 true)) (= PMS@assigned~7 true)) (= GhostAssertions@assigned~7 true)) (= have_reply___char@v@assigned~4 true))) node_Err_ok_33)))
(check-sat)
